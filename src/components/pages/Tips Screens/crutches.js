      ...
      <ScrollView>
        <View onStartShouldSetResponder={() => true}>
          <Text style={styles.tip}>
            ...
            {'\n'}
            {'\n'}
            <Text style={styles.number}>2.</Text> Put a pillowcase over your
            cast or boot when you go to sleep to protect your sheets
            {'\n'}
            {'\n'}
            <Text style={styles.number}>3.</Text> Move slowly and as steadily as
            possible when using crutches on wet, smooth surfaces. The crutches
            may slip if you move too fast.
            {'\n'}
            {'\n'}
            <Text style={styles.number}>4.</Text> When going up steps, place the
            crutches on the next landing first and carefully jump onto the
            landing (where crutches already are) with the good leg
            {'\n'}
            {'\n'}
            <Text style={styles.number}>5.</Text> Inside your dorm room use a
            satchel, purse, or grocery bag when you have to carry things from
            room to room
            {'\n'}
            {'\n'}
          </Text>
