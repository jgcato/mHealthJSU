      ...
      <ScrollView>
        <View onStartShouldSetResponder={() => true}>
          <Text
            ...
            normally would, it is necessary to change your eating habits while
            you are temporarily inactive. {'\n'}
            {'\n'}{' '}
            <Text style={{fontWeight: '200'}}>
              Consider some of these tips on how to prevent excessive weight
              gain while injured:
            </Text>
          </Text>
          <Text style={styles.tip}>
            {' '}
            <Text style={styles.number}>1.</Text> Stay away from mindless
            snacking
            {'\n'}
            {'\n'}
            <Text style={styles.number}>2.</Text> Plan your meals ahead of time
            so that you continue to make healthy eating choices
            {'\n'}
            {'\n'}
            ...
            with added sugars & concentrated sweets, and alcohol. These foods
